...
try:
    with open(f'.\\_drafts\\{MD_FILE}\\index.mdx', 'r') as input_file, open(f".\\_drafts\\{MD_FILE}\\index.mdx.fix", 'w') as output_file:
...
with open(f'.\\_drafts\\{MD_FILE}\\index.mdx', 'w') as input_file, open(f".\\_drafts\\{MD_FILE}\\index.mdx.fix", 'r') as output_file:
    text = output_file.read()
    input_file.write(text)

#os.remove(f".\\_drafts\\{MD_FILE}\\index.mdx.fix")
