...
description: yes, it's just client-server computing at the end of the day, but you have to program the initial callback, then each command, how that plays with the server...
...
![Pasted%20image%2020230122020600.png](https://an00brektn.github.io/img/havoc-implant/Pasted%20image%2020230122020600.png)
...
![Pasted%20image%2020230122014150.png](https://an00brektn.github.io/img/havoc-implant/Pasted%20image%2020230122014150.png)
