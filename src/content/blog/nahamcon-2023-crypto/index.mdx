...
<img src="https://ctftime.org/media/events/naham_banner.png" style="width:60%;height:60%"></img>
...
$$
\begin{aligned} 
    \phi(n) &= (p-1)(q-1) \\\\ \phi(n) &= pq - p - q + 1 \\\\ \phi(n) &= (2q+1)q - (2q+1) - q + 1 \\\\ 0 &= 2q(q-1)-\phi(n)
\end{aligned}
$$
...
$$
\begin{aligned} 
    r_1f_1 + r_2f_2 + r_3f_3 + ... + r_{38}f_{38} &= s_1 \\ r_{38}f_1 + r_1f_2 + r_2f_3 + ... + r_{37}f_{38} &= s_2 \\ r_{37}f_1 + r_{38}f_2 + r_1f_3 + ... + r_{36}f_{38} &= s_3 \\ & \vdots \\ r_3f_1 + r_4f_2 + r_5f_3 + ... + r_2f_{38} &= s_{37} \\
\end{aligned}
$$
...
$$
\begin{bmatrix} 
r_1 & r_2 & r_3 & ... & r_{38} & s_1 \\ r_{38} & r_1 & r_2 & ... & r_{37} & s_2 \\ r_{37} & r_{38} & r_1 & ... & r_{36} & s_3 \\ \vdots & \vdots & \vdots & ... & \vdots & \vdots \\ r_3 & r_4 & r_5 & ... & r_2 & s_{37} 
\end{bmatrix}
$$
...
$$
\begin{bmatrix} 
    1 & 0 & 0 & ... & k_1 & s'_1 \\ 0 & 1 & 0 & ... & k_2 & s'_2 \\\\ 0 & 0 & 1 & ... & k_3 & s'_3 \\ \vdots & \vdots & \vdots & ... & \vdots & \vdots \\ 0 & 0 & 0 & ... & s'_{37} & s_{37} 
\end{bmatrix}
$$
...
$$\begin{aligned} s_1 - s_2 &= k^{-1}(h_1 + r_1d) - k^{-1}(h_2 + r_2d) \\\\ s_1 - s_2 &= k^{-1}(h_1 - h_2 + d(r_1 - r_2))\\\\ s_1 - s_2 &= k^{-1}(h_1 - h_2) \\\\ k &= (h_1 - h_2)(s_1-s_2)^{-1} \end{aligned}$$
