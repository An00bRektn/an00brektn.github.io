...
- If `SameSite=Strict`, the browser will not send the cookie on cross-site requests.
...
Ok, ok, I am leaving out some important details on the difference between "sites" and "origins", which is relevant when discussing when CORS is and isn't secure. Breaking down how some requests can be *cross-origin* but *same-site* can get a little confusing at this point, so for now, I've left it out in the interest of simplicity and keeping this post a little more focused. That said, if you are interested in learning more, here are some resources (thank you [jub0bs](https://bsky.app/profile/jub0bs.com/post/3lx2o4l7y3223) for the nitpick):
...
- [jub0bs: The Great SameSite Confusion](https://jub0bs.com/posts/2021-01-29-great-samesite-confusion/)
</Callout>
