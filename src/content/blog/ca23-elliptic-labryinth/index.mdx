...
image: /public/static/frontmatter/og-cyber-apocalypse-ctf-2023.jpg
tags:
- crypto
- ecc
- coppersmith
...
$$
\begin{aligned} 
    y_1^{2} &= x_1^3 + ax_1 + b_1 \\\\ y_2^2 &= x_1^3 + ax_2 + b_2 
\end{aligned}
$$
...
$$
\begin{aligned}
    a &= (x_1 - x_2)^{-1}(y_1^2 - y_2^2)-(x^3_1 - x^3_2) \\\\ b &= y_2^2 - x^3_1 - ax_1 
\end{aligned}
$$
...
$$
\begin{aligned} 
    y^2 = x^3+ax+b &\rightarrow y^2 = x^3 + (a_t+a_r)x + (b_t+b_r) \\\\ &\rightarrow 0 = x^3 + (a_t+a_r)x + (b_t+b_r) - y^2 
\end{aligned}
$$
